...
contract GLORYUSDTSharePool is
    LPTokenWrapper, Ownable
{
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'GLORYUSDTSharePool: Cannot stake 0');
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'GLORYUSDTSharePool: Cannot withdraw 0');
