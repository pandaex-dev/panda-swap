...
contract BABYDOGEUSDTSharePool is
    LPTokenWrapper, Ownable
{
    ...
    modifier checkStart() {
        require(
            ...
            'BABYDOGEUSDTSharePool: not start'
        );
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'BABYDOGEUSDTSharePool: Cannot stake 0');
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'BABYDOGEUSDTSharePool: Cannot withdraw 0');
