    ...
    LPTokenWrapper, Ownable
{
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'PNDUSDTSharePool: Cannot stake 0');
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'PNDUSDTSharePool: Cannot withdraw 0');
